...
<body>
    ...
    <main class="main-content">
        <div class="page-container">
            ...
            <div class="table-container-card">
                ...
                <form action="{{ route('simpan.pelatihBaru') }}" method="POST" id="pelatihForm" style="margin-top: 30px;" enctype="multipart/form-data">
                    @csrf
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // image preview for foto input
            const fotoInput = document.getElementById('foto');
            if(fotoInput){
                // create preview element next to input
