...
<head>
    ...
    <title>Tambah Pelatih - Dinas Pariwisata Pemuda dan Olahraga</title>
...
<body>
    ...
    <main class="main-content">
        <div class="page-container mt-32 sm:mt-40">
            ...
            <div class="table-container-card">
                ...
                <form action="{{ route('simpan.update.pelatih') }}" method="POST" enctype="multipart/form-data" style="margin-top: 30px;">
                    @csrf
    ...
    <script>
        // Form submission
        // document.getElementById('pelatihForm').addEventListener('submit', function(e) {
        //     e.preventDefault();
