...
<body>
    ...
    <main class="main-content">
        <div class="page-container mt-32 sm:mt-40">
            ...
            <div class="table-container-card">
                ...
                <form action="{{ route('simpan.jadwal.baru') }}" method="POST" style="margin-top: 30px;">
                    @csrf
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Dynamic lapangan options based on cabang olahraga
            ...
            const lapanganOptions = {
                'Sepak Bola': ['Lapangan Sepak Bola Utama', 'Lapangan Sepak Bola Latihan'],
                'Basket': ['Lapangan Basket Indoor', 'Lapangan Basket Outdoor'],
                'Voli': ['Lapangan Voli Indoor', 'Lapangan Voli Outdoor'],
                'Badminton': ['Lapangan Badminton Hall A', 'Lapangan Badminton Hall B', 'Lapangan Badminton Hall C'],
                'Tenis': ['Lapangan Tenis Court 1', 'Lapangan Tenis Court 2'],
                'Futsal': ['Lapangan Futsal Indoor', 'Lapangan Futsal Outdoor'],
                'Atletik': ['Lintasan Atletik', 'Lapangan Lompat'],
                'Renang': ['Kolam Renang Utama', 'Kolam Renang Latihan'],
                'Bulu Tangkis': ['Lapangan Badminton Hall A', 'Lapangan Badminton Hall B']
            };
            
            cabangOlahragaSelect.addEventListener('change', function() {
                const selectedCabor = this.value;
                lapanganSelect.innerHTML = '<option value="">Pilih Lapangan</option>';
                
                if (selectedCabor && lapanganOptions[selectedCabor]) {
                    lapanganOptions[selectedCabor].forEach(lapangan => {
                        const option = document.createElement('option');
                        option.value = lapangan;
                        option.textContent = lapangan;
