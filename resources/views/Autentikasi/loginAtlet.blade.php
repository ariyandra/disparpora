        ...
        <div class="login-container">
            <div class="login-card">
                ...
                <div class="login-header">
                    ...
                    <p class="login-subtitle">Masuk sebagai atlet untuk melanjutkan</p>
                </div>
                ...
                <!-- Login Form -->
                <form class="login-form" method="POST" action="{{ route('login.atlet.submit') }}">
                    @csrf
                    ...
                    <p class="login-subtitle">Masuk sebagai <a href="{{ route('login.pelatih') }}">Pelatih</a> / <a href="{{ route('login.admin') }}">Admin</a> </p>
