...
<body>
    <nav class="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="{{ route('lapangan.pelatih') }}" class="nav-link active">Lapangan</a>
                </li>
                <li class="nav-item">
    ...
    <script>
        ...
        (function () {
            ...
            function getAllRows() {
                return Array.from(document.querySelectorAll(`${tableBodySelector} tr`));
            }
            ...
            function renderPaginationButtons(totalPages) {
                ...
                // remove existing numeric buttons (keep prev/next)
            ...
            function showPage(page) {
                ...
                visibleRows.slice(start, end).forEach(r => {
                    r.style.display = '';
                    r.style.animation = 'fadeIn 0.25s ease';
                });
            ...
            document.addEventListener('DOMContentLoaded', function () {
                // inject fadeIn keyframes (if not present)
            ...
            // Expose changePage globally for existing prev/next buttons
