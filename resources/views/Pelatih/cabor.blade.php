...
<head>
    ...
    <title>Cabang Olahraga - Nama Website</title>
    ...
    <nav class="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="{{ route('cabor.pelatih') }}" class="nav-link active">Cabang Olahraga</a>
                </li>
                <li class="nav-item">
    ...
    <script>
        ...
        function handleLogout() {
            if (confirm('Apakah Anda yakin ingin logout?')) {
                ...
                btn.innerHTML = '<span class="loading"></span> Logout...';
                btn.disabled = true;
