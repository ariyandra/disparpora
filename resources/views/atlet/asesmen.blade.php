...
<body>
    <nav class="navbar">
        <div class="nav-container">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item">
                    <a href="{{ route('atlet.asesmen') }}" class="nav-link active">Asesmen</a>
                </li>
                <li class="nav-item">
                ...
                <table class="data-table" id="asesmenTable">
                    ...
                    <tbody id="asesmenTableBody">
                        ...
                        <tr>
                            ...
                            <td>{{ $a->atlet->nama }}</td>
                            <td>{{ $a->pelatih->nama }}</td>
                            <td>{{ $a->tanggal_asesmen }}</td>
                            <td>{{ $a->aspek_fisik }}</td>
                            <td>{{ $a->aspek_teknik }}</td>
                            <td>{{ $a->aspek_sikap }}</td>
                            <td>{{ $a->keterangan }}</td>
                        </tr>
                        @endforeach
    ...
    <script>
        ...
        window.addEventListener('load', function() {
            const tableRows = document.querySelectorAll('#asesmenTableBody tr');
