            ...
            <div class="page-header-card">
                <div class="flex justify-between items-center">
                    ...
                    <div style="display:flex;gap:12px;align-items:center;">
                        <a href="{{ route('tambah.atlet') }}" class="btn-tambah" style="text-decoration: none;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <form action="{{ route('hapus.atlet') }}" method="POST">
                                            @csrf
                                            <input type="hidden" value="{{ $atlet->id }}" name="id_atlet">
