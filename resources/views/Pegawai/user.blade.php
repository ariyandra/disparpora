...
<head>
    ...
    <title>User - Dinas Pariwisata Pemuda dan Olahraga</title>
...
<body>
        ...
        <div class="page-container mt-32 sm:mt-40">
            ...
            <div class="page-header-card">
                <div class="flex justify-between items-center">
                    ...
                    <a href="{{ route('tambahUser') }}" class="btn-tambah" style="text-decoration: none;">
            ...
            <div class="table-container-card">
                <div class="table-header">
                    ...
                    <div class="search-container">
                        ...
                        <input type="text" class="search-input" placeholder="Cari user..." id="searchInput">
                    </div>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-buttons">
                                    <form action="{{ route('ubahDataUser') }}" method="POST">
                                        @csrf
    ...
    <script>
        ...
        (function () {
            ...
            const tableBodySelector = '#userTableBody';
        ...
        // Action functions
        function editUser(id) { alert(`Mengedit user dengan ID: ${id}`); }
        function deleteUser(id) {
            if (confirm('Apakah Anda yakin ingin menghapus user ini?')) {
                const btn = event.target.closest('button');
                btn.innerHTML = '<span class="loading"></span> Menghapus...';
                btn.disabled = true;
                setTimeout(() => { alert(`User dengan ID ${id} berhasil dihapus!`); btn.closest('tr').remove(); }, 1000);
            }
        }
