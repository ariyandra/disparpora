...
<head>
    ...
    <title>Import Pelatih - DISPARPORA</title>
    <link href="{{ asset('css/pelatih.css') }}" rel="stylesheet">
</head>
<body>
    <main style="padding:24px;">
        <h1>Import Data Pelatih (Excel)</h1>
        ...
        <form action="{{ route('import.pelatih.submit') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div style="margin-top:16px;">
                ...
                <a href="{{ route('data.pelatih') }}" style="margin-left:12px;">Kembali</a>
            </div>
        </form>
